        ...
        function(e, t, i) {
            ...
            (i(2).inspectSource = function(e) {
                ...
                (e.exports = function(e, t, i, n) {
                    ...
                    return (
                        ('function' == typeof this && this[a]) || n.call(this)
                    );
                });
        },
        function(e, t, i) {
    ...
    (function(e, t) {
        ...
        return function n(e) {
            if (
                ...
                for (
                    var o = (i.isBorderBox = 'border-box' == t.boxSizing),
                        r = 0;
                    r < b;
                    r++
                ) {
    ...
    (function(l, s) {
        ...
        return (
            ...
            (y.getParentCell = function(e) {
                return (
                    this.getCell(e) ||
                    ((e = s.getParent(e, '.flickity-slider > *')),
                    this.getCell(e))
                );
            }),
    ...
    (function(n, o) {
        ...
        (n._createDrag = function() {
            this.on('activate', this.onActivateDrag),
                ...
                o &&
                    !r &&
                    (i.addEventListener('touchmove', function() {}), (r = !0));
        }),
            ...
            (e.navCompanionSelect = function(e) {
                if (this.navCompanion) {
                    var t,
                        ...
                        r = Math.floor(
                            (o - (t = n)) * this.navCompanion.cellAlign + t
                        );
                    if (
    ...
    (function(e, t) {
            ...
            try {
                p(d(e), function(e) {
                    ...
                    if (null !== t) {
                        ...
                        i.callbackTimer &&
                            window.clearTimeout(i.callbackTimer.clock),
        ...
        function I(e) {
            ...
            if (6 !== e.length)
                throw new RangeError(
                    'Expected array with either 6 or 16 values.'
                );
            var t = O();
            return (
                (t[0] = e[0]),
        ...
        function H(e, t) {
            for (var i = I(e), n = I(t), o = [], r = 0; r < 4; r++)
                for (
                    var l = [i[r], i[r + 4], i[r + 8], i[r + 12]], s = 0;
                    s < 4;
                    s++
                ) {
                    var a = 4 * s,
        ...
        function f(e) {
            ...
            if (parseFloat(n.distance)) {
                ...
                switch (k[1]) {
                    ...
                    case '%':
                        E =
                            'Y' === S
                                ? (e.node.getBoundingClientRect().height * z) /
                                  100
                                : (e.node.getBoundingClientRect().width * z) /
                                  100;
                        break;
                    default:
                        throw new RangeError(
            ...
            n.rotate.x &&
                ...
                1 !== n.scale &&
                    (0 === n.scale ? M.push(T(2e-4)) : M.push(T(n.scale)));
            var A = {};
            if (M.length) {
                    ...
                    (A.computed = {
                        ...
                        matrix: (function(e) {
                            if ('string' == typeof e) {
                                ...
                                if (t)
                                    return I(t[2].split(', ').map(parseFloat));
                            }
                            return O();
                        })(t[A.property])
                    }),
            ...
            if (w.generated || A.generated.initial) {
                ...
                var j = D.fragments.reduce(
                    function(e, t, i) {
                        return (
                            (e.delayed +=
                                0 === i ? t.delayed : ', ' + t.delayed),
                            (e.instant +=
                                0 === i ? t.instant : ', ' + t.instant),
                            e
                        );
                    },
                    { delayed: '', instant: '' }
        ...
        function c(e, t) {
            ...
            if (i) {
                ...
                if (
                    ((i.models = { visible: o, revealed: r }), !r.body.length)
                ) {
            ...
            (this.head = []),
                ...
                this.body.length &&
                    p(e.members, function(e, t) {
                        ...
                        i &&
                            !i[n] &&
                            (t < r.body[0] ? r.head.push(t) : r.foot.push(t));
                    });
        }
        function m(e, t, i, n) {
            var o = this,
        ...
        function x() {
            ...
            t.call(this),
                ...
                p(this.store.containers, function(e) {
                    var t =
                        e.node === document.documentElement ? window : e.node;
        ...
        function n(e, s, t) {
            ...
            try {
                ...
                p(
                    ...
                    function(e) {
                        (a.store.elements[e.id] = e).node.setAttribute(
                            'data-sr-id',
                            e.id
                        );
                    }
        ...
        function V(e) {
            ...
            try {
                ...
                return (
                    u.call(this, 'Invalid configuration.', e.message),
                    i.failure()
                );
            }
            try {
